...

{
    ...
    public partial class FrmMediatek : Form
    {
        ...
        {
            EffectuerRechercheMulticritere();
        }
        ...
        private void EffectuerRechercheMulticritere()
        {
            if (cbxLivresGenres.SelectedIndex >= 0 && cbxLivresPublics.SelectedIndex >= 0)
            {
                txbLivresTitreRecherche.Text = "";
                txbLivresNumRecherche.Text = "";
                ...
                List<Livre> livres = lesLivres.FindAll(x => x.Genre.Equals(genre.Libelle) && x.Public.Equals(lePublic.Libelle));
                RemplirLivresListe(livres);
        ...
        {
            if (comboBoxRevues.SelectedItem != null)
            {
                string numeroRevueSelectionne = comboBoxRevues.SelectedItem.ToString();
                Revue revue = lesRevues.Find(x => x.Id.Equals(numeroRevueSelectionne));
                if (revue != null)
                {
            ...
            {
                MessageBox.Show("Veuillez sélectionner un numéro de revue.");
            }
        }
